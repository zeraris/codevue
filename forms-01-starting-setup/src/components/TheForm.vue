<template>
  <form @submit.prevent="submitHandler">
    <div class="form-control" :class="{invalid: userNameValid === 'invalid'}">
      ...
      <input id="user-name" name="user-name" type="text" v-model.trim="inputUser" @blur="validateInput"/>
      <p v-if="userNameValid === 'invalid'">Please write correct input</p>
    </div>
    ...
    <div class="form-control">
      ...
      <div>
        <input id="how-video" name="how" type="radio" value="video course" v-model="how"/>
...
export default {
  ...
  methods: {
    submitHandler() {
      console.log('username: ' + this.inputUser)
      this.inputUser = ""
